...
{
    public interface ResourceSet : Notifier
    {
        /**
   ...
   */
         ...
         * @see org.eclipse.emf.ecore.util.EcoreUtil#getAllContents(ResourceSet, bool)
         */
         ...
         */
        Dictionary<Object, Object> getLoadOptions();
         ...
         */
        EObject getEObject(Uri uri, bool loadOnDemand);
         ...
         * @throws org.eclipse.emf.common.util.WrappedException if a problem occurs during demand load.
         */
        Resource getResource(Uri uri, bool loadOnDemand);
